...
@section('title','Teacher show  contents')
@section('main-content')
<div class="container">

	<div class="row mt-2">
		<div class="col-md-12">
			<a href="{{route('teacher.content.create')}}"><button class="btn btn-info">Add New Content</button></a>
		</div>
                ...
                <tr>
                  ...
                  <td>
                  	...
                  	<button class="btn btn-info btn-sm">
                  		<a href="{{route('teacher.content.edit',['id'=>$content->id])}}" style="color:black;">
                          ...
                          <i class="fa fa-trash"></i>
		                  	...
		                  	<form id="delete_form_{{$content->id}}" method="post" action="{{route('teacher.content.delete',['id'=>$content->id])}}" style="display: none;">
		                  		@method('DELETE')
		                  		@csrf
